    ...
    <div className="p-8">
        ...
        <div className="flex justify-center space-x-3">
          {code.map((digit, index) => (
            <input
              ...
              className="w-12 h-12 text-center text-lg font-semibold border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
              disabled={isLoading}
            />
          ))}
        </div>
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <a 
            href="mailto:support@avadgh.com" 
